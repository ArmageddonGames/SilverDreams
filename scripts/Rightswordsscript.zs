...
const int swordSwitchFFC1 = 29; //Set to the slot of the swordSwitch FFC
ffc script swordSwitch1{
...
void NoMovement1(){ //Prevents moving in any direction
